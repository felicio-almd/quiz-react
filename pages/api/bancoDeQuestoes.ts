...
const questoes: QuestaoModel[] = [
    new QuestaoModel(306, 'Qual bixo trasmite a Doença de Chagas', [
        RespostaModel.errada('Abelha'),
        RespostaModel.errada('Barata'),
        RespostaModel.errada('Pulga'),
        RespostaModel.certa('Barbeiro')

        // Fatoracao com as respostas certa sem usar metodos estaticos
        // new RespostaModel('Abelha', false),
        // new RespostaModel('Barata', false),
        // new RespostaModel('Pulga', false),
        // new RespostaModel('Barbeiro', true)
    ]),
    new QuestaoModel(202, 'Qual fruta é conhecida no Norte e no Nordeste como "jerimum"?', [
